%% Hybrid Electric Aircraft (VTOL) Component Sizing
%
...
set_param(find_system('ssc_airvtol_elec_hybrid','MatchFilter',@Simulink.match.allVariants,'FindAll', 'on','type','annotation','Tag','ModelFeatures'),'Interpreter','off')
