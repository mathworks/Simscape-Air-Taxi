...
if (~exist('temp_dist_payl_ele_hybr','var'))
    ...
    load ssc_airvtol_sweep_payloadbattery_compare_defResults
end

% Prepare figure window
if ~exist('h10_ssc_airvtol', 'var') || ...
        ~isgraphics(h10_ssc_airvtol, 'figure')
    h10_ssc_airvtol = figure('Name', 'ssc_airvtol_elec');
end
figure(h10_ssc_airvtol)
clf(h10_ssc_airvtol)
...
if ~exist('h9_ssc_airvtol', 'var') || ...
        ~isgraphics(h9_ssc_airvtol, 'figure')
    h9_ssc_airvtol = figure('Name', 'ssc_airvtol_elec');
end
figure(h9_ssc_airvtol)
clf(h9_ssc_airvtol)
