...
FlightProfileStruct(1).FlightProfileHeight = 200;   % Maximum height of aircraft in m
FlightProfileStruct(1).FlightProfileLength = 2000;  % Maximum flight period length in sec
...
FlightProfileStruct(2).h0 = 500;                    % Initial height of aircraft in m
FlightProfileStruct(2).FlightProfileHeight = 600;   % Maximum height of aircraft in m
FlightProfileStruct(2).FlightProfileLength = 2000;  % Maximum flight period length in sec
...
FlightProfileStruct(3).ClimbFlightTime = 200;       % Climb flight period length in sec
FlightProfileStruct(3).FlightProfileLength = 2000;  % Maximum flight period length in sec
...
FlightProfileStruct(4).h0 = 500;                    % Initial height of aircraft in m
FlightProfileStruct(4).ClimbFlightTime = 200;       % Climb flight period length in sec
FlightProfileStruct(4).FlightProfileLength = 2000;  % Maximum flight period length in sec
